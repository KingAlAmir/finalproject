        ...
        <div class="col-lg-6 m-auto">
            <div class="card mt-5">
                <div class="card-title">
                    <h3 class="bg-warning text-white text-center py-3"> Patient Registration Form</h3>
                </div>
                <div class="card-body">
                    ...
                    <form action="insert.php" method="post">
                        ...
                        <input type="text" class="form-control mb-2" placeholder=" Insurance Code " name="Code">
