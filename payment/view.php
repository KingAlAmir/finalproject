                ...
                <table class="table table-bordered">
                    ...
                    while($row=mysqli_fetch_assoc($result))
                    {
                        ...
                        <tr>
                            ...
                            <td><a href="edit.php?GetID=<?php echo $PaymentCode ?>">Edit</a></td>
                            <td><a href="delete.php?Del=<?php echo $PaymentCode ?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
                        </tr>
                        <?php
                    }
                    ?>
